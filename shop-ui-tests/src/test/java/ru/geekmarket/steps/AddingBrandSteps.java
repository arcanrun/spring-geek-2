...
//    Then I click submit btn
    ...
    @Then("I click on brand navigation link")
    public void iClickOnBrandNavigationLink() throws InterruptedException {
        Thread.sleep(1000);
        WebElement webElement = webDriver.findElement(By.xpath("/html/body/div[1]/div[1]/ul/li[4]/a"));
        webElement.click();
    }

    @Then("I click on create new btn")
    public void iClickOnCreateNewBtn() throws InterruptedException {
        Thread.sleep(1000);
        WebElement webElement = webDriver.findElement(By.xpath("/html/body/div/div[2]/div/div/form/button"));
        webElement.click();
    }

    @Then("I provide brand name as {string}")
    public void iProvideBrandNameAs(String arg0) throws InterruptedException {
        Thread.sleep(1000);
        WebElement webElement = webDriver.findElement(By.xpath("/html/body/div/div[2]/form/div/div[1]/div/input"));
